...
static void n8x0_nand_setup(struct n800_s *s)
{
    ...
    omap_gpmc_attach(s->cpu->gpmc, N8X0_ONENAND_CS, s->nand, 0);
...
static void n8x0_usb_setup(struct n800_s *s)
{
    ...
    omap_gpmc_attach(s->cpu->gpmc, N8X0_USB_SYNC_CS, s->usb, 0);
    omap_gpmc_attach(s->cpu->gpmc, N8X0_USB_ASYNC_CS, s->usb, 1);
